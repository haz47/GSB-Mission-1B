...
*/
	...
	public function getMois($num, $type) {
		$req = "select mois, quantite from lignefraisforfait where idVisiteur = '$num' and idFraisForfait = '$type'";
		$rs = PdoGsb::$monPdo->query($req);
		$ligne = $rs->fetchAll();
		return $ligne;
	}
	...
	public function getCount() {
		$req = "select count(id) from fraisforfait";
		$rs = PdoGsb::$monPdo->query($req);
		$ligne = $rs->fetch();
		return $ligne;
	}
